...
// 图标配置
let currentConfig: DeepPartial<IIconConfig> = DEFAULT_ICON_CONFIGS

export function setConfig(config: DeepPartial<IIconConfig>): void {
    currentConfig = config
}

export function getConfig(): DeepPartial<IIconConfig> {
