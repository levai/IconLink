...
export interface IIconLinkInstance extends IIconInstance {
...
const options: ComponentOptions<IIconLinkInstance> = {
    name: 'icon-space',
    props: ['tag', 'type', 'theme', 'size', 'spin', 'fill', 'strokeLinecap', 'strokeLinejoin', 'strokeWidth'],
    render(this: IIconLinkInstance, h): VNode {
...
export const IconLink: VueConstructor<IIconAllProps> = options as VueConstructor<IIconAllProps>
